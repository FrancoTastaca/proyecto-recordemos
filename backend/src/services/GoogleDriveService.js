...
const { green, blue, yellow, red, magenta } = pkg
dotenv.config()
...
export default class GoogleDriveService {
  ...
  async createFolder(folderName, parentFolderId) {
    try {
      ...
      console.log('entre despues del filemetaData', fileMetadata)
      ...
      console.error(red(`Error al crear la carpeta en Google Drive: ${error}`))
      throw error
    }
  }
